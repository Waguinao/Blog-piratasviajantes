...
*/
		...
		this.drawInputs = function(id){	
			...
			for( key in inputs){		
				...
				var cssclass =  inputs[key].cssclass || null;

				var optionsval = "";
				var option_selected = "";
				var thumblist_options = "";
				var colname = "";
				var cssclassHtml = " class='"+cssclass+"' ";
				...
				if(type == 'submit'){
					inputsHtml = '<button type="submit" data-type="submit" name="'+key+'" id="windbox_input_'+id+'_'+key+'" '+cssclassHtml+' >'+value+'</button>';					
				}else if(type == 'button'){
					inputsHtml = '<button type="button" data-type="button" name="'+key+'" id="windbox_input_'+id+'_'+key+'" '+cssclassHtml+' >'+value+'</button>';
				}else if(type == 'a'){
					inputsHtml = '<a name="'+key+'" id="windbox_input_'+id+'_'+key+'" data-type="a" '+cssclassHtml+' >'+value+'</a>';

				}else if(type == 'hidden'){
					inputsHtml = '<input type="'+type+'" value="'+value+'"  placeholder="'+placeholder+'" name="'+key+'" id="windbox_input_'+id+'_'+key+'" data-type="text" '+required+' '+cssclassHtml+' >';
				}else if(type == 'text'){
					inputsHtml = '<input type="'+type+'" value="'+value+'"  placeholder="'+placeholder+'" name="'+key+'" id="windbox_input_'+id+'_'+key+'" data-type="text" '+required+' '+cssclassHtml+' >';
				}else if(type == 'label'){
					inputsHtml = '<label name="'+key+'" id="windbox_input_'+id+'_'+key+'" data-type="label" '+cssclassHtml+'  >'+value+'</label>';	
				}else if(type == 'file'){
					inputsHtml = '<input type="'+type+'" value="'+value+'"  name="'+key+'" id="windbox_input_'+id+'_'+key+'" data-type="file" '+required+' '+cssclassHtml+' >';
				}else if(type == 'textarea'){
					inputsHtml = '<textarea  name="'+key+'" placeholder="'+placeholder+'" id="windbox_input_'+id+'_'+key+'" data-type="textarea" '+required+' '+cssclassHtml+' >'+value+'</textarea>';
				}else if(type == 'select'){
					inputsHtml = '<select  name="'+key+'"  id="windbox_input_'+id+'_'+key+'" data-type="select" '+required+' '+cssclassHtml+' >'+optionsval+'</select>';
				}else if(type == 'column'){					
					inputsHtml = '</div><div name="'+key+'" data-type="col"  id="windbox_input_'+id+'_'+key+'" '+cssclassHtml+' >';
				...
				if(label != null){
					inputsHtml = '<label id="windbox_inputlabel_'+id+'_'+key+'" '+cssclassHtml+' >'+label+'</label>'+inputsHtml;
				}
