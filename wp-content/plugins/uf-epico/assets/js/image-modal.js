...
function uf_epico_open_imagemodal(el){
	...
	frame.on('select',function(){
		...
		preview.css('background', '#efefef url('+srcurl+') center center / '+response+' no-repeat').append('<span class="filechanger-btn uf_epico_media_select changer">Change Image</span>');
