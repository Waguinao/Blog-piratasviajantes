        ...
        if(is_front_page()) {
            ...
            echo '<!--[if IE]><div' . ( isset( $custom_id ) ? ' id="cw-' . sanitize_html_class( $custom_id ) . '" ' : '' ) . ' class="capture-wrap uf-wrap ' . (( 2 == $atts['sidebar']) ? 'sb' : 'fw' ) . ' ie"><![endif]--><!--[if !IE]><!--><div' . ( isset( $custom_id ) ? ' id="cw-' . sanitize_html_class( $custom_id ) . '" ' : '' ) . ' class="capture-wrap uf-wrap '.(( 2 == $atts['sidebar'])?'sb':'fw') . '"><!--<![endif]-->';
                ...
                echo '<div class="capture uf">';
                    ...
                    echo '<div class="capture-container uf-container">';
                        ...
                        if(true == $atts['icon_upload']) {
                            ...
                            echo '<p class="capture-icon uf-icon"><img src="' . esc_url( implode(", ", (array)$atts['icon_upload']) ) . '" class="icon';
                    ...
                    echo '<p itemprop="text" class="capture-intro uf-intro '.((1 == $atts['disable_animation'])?'fadeinright':'').'">' . balanceTags( implode(", ", (array)$atts['intro_p']) , true ) . '<span class="uf-arrow"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46.322 60"><polygon' . ( ( 1 == $atts[ 'override' ] ) ? ' fill="' . esc_attr( implode( ", ", (array)$atts[ 'arrow_color' ] ) ) . '"' : '' ) . ' points="33.831,36.839 23.161,0 12.491,36.839 0,36.839 23.161,60 46.322,36.839"/></svg></span></p>';
                ...
                echo '<div class="capture capture-form uf '.((1 == $atts['disable_animation'])?'animated':'').'">';
                    ...
                    echo '<div class="capture-container uf-container">';
                        ...
                        if(1 == $atts['sidebar']) {
                            ...
                            echo '<p itemprop="text" class="capture-notice uf-notice '.((1 == $atts['disable_animation'])?'fadeinleft':'').'">' .balanceTags( implode(", ", (array)$atts['notice']) , true ) . '</p>';
                        }
                        ...
                        if ( 1 == $atts[ 'email_service' ] ) { // MailChimp
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) . '&ORIGEM=[' . sanitize_html_class( $custom_id ) . __( ']%20in%20[', 'uf-epico' ) . $slug . ']' : '' ) . '" name="mc-embedded-subscribe-form" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 2 == $atts[ 'email_service' ] ) { // AWeber
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' : '' ) . ' method="post" accept-charset="iso-8859-1" action="http://www.aweber.com/scripts/addlead.pl" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 3 == $atts[ 'email_service' ] ) { // MadMimi
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" accept-charset="UTF-8" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 4 == $atts[ 'email_service' ] ) { // Campaign Monitor
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 5 == $atts[ 'email_service' ] ) { // e-Goi
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" enctype="multipart/form-data" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 6 == $atts[ 'email_service' ] ) { // Get Response
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . '  method="post" accept-charset="utf-8" action="https://app.getresponse.com/add_subscriber.html" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 8 == $atts[ 'email_service' ] ) { // Mail Relay
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" enctype="application/x-www-form-urlencoded" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 9 == $atts[ 'email_service' ] ) { // KlickMail
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" action="https://www.klickmail.com.br/subscribe.php" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . ' accept-charset="UTF-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 11 == $atts[ 'email_service' ] ) { // Active Campaign
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="post" enctype="multipart/form-data" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '" accept-charset="utf-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 12 == $atts[ 'email_service' ] ) { // RD Station
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="POST" action="https://www.rdstation.com.br/api/1.2/conversions" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 14 == $atts[ 'email_service' ] ) { // Sendy
                                ...
                                echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" ' : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="POST" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '/subscribe" accept-charset="utf-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 15 == $atts[ 'email_service' ] ) { // Benchmark
                                ...
                                echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" ' : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="POST" action="https://lb.benchmarkemail.com//code/lbform" accept-charset="UTF-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 16 == $atts[ 'email_service' ] ) { // Mail2Easy - Dinamize
                                ...
                                echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" ' : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="POST" action="' . ( ( 1 == $atts[ 'optin' ] ) ? 'http://cache.mail2easy.com.br/integracao' : 'http://cache.mail2easy.com.br/double-optin' ) . '" accept-charset="UTF-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 17 == $atts[ 'email_service' ] ) { // MyMail
                                ...
                                echo '<form action="' . get_site_url() . '/wp-admin/admin-ajax.php" method="post" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 18 == $atts[ 'email_service' ] ) { // Trafficwave
                                ...
                                echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" ' : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . 'name="TRWVLCPForm" method="POST" action="http://www.trafficwave.net/cgi-bin/autoresp/inforeq.cgi" accept-charset="UTF-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 19 == $atts[ 'email_service' ] ) { // InfusionSoft
                            ...
                            echo '<form ' . ( isset( $custom_id ) ? 'id="' . sanitize_html_class( $custom_id ) . '" '  : '' ) . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' method="POST" action="' . ( isset( $atts[ 'form_action' ] ) ? esc_url( $atts[ 'form_action' ] ) : '' ) . '" accept-charset="UTF-8" ' . ( ( 1 == $atts[ 'new_window' ] ) ? 'target="_blank"' : '' ) . '>
                        ...
                        if ( 20 == $atts[ 'email_service' ] ) { // Google Docs
                ...
                if(1 == $atts['sidebar']) {
                    ...
                    printf('<script type="text/javascript">var uf_widget_notice = document.getElementById(\'cw-' . sanitize_html_class( $custom_id ) . '\');uf_widget_notice.insertAdjacentHTML(\'beforeend\', \'<div style="display: none" class="capture-overlay uf-overlay"><div class="capture-overlay-warning uf-overlay-warning">%s <a class="capture-link uf-link" href="' . get_admin_url( '', 'customize.php', '' ) . '">%s</a>%s</div></div>\');</script>',
                        __( 'This area is too narrow for this version of the widget. Relocate it to a wider area or activate the sidebar version', 'uf-epico' ),
                        __( 'on the widget options', 'uf-epico' ),
                        __( ', inside the "Customization" tab.', 'uf-epico' ));
                    ...
                    echo '<div class="capture-container uf-container">';
                        ...
                        if(1 == $atts['sidebar']) {
                            ...
                            if(true == $atts['icon_upload']) {
                                ...
                                echo '<p class="capture-iconinner uf-iconinner"><img src="' . esc_url( implode(", ", (array)$atts['icon_upload']) ) . '" class="icon';
                            ...
                            if(true == $atts['icon']) {
                                ...
                                echo '<p class="capture-iconinner uf-iconinner"><i class="' . esc_attr( implode(", ", (array)$atts['icon']) );
                        ...
                        if ( 21 == $atts[ 'email_service' ] ) { // Mail Poet
                            ...
                            echo '<form ' . ( ( 1 == $atts[ 'disable_animation' ] ) ? 'class="fadeinright"' :'' ) . ' action="#wysija" method="POST" target="no-target-'  . esc_attr( $custom_id ) . '" onsubmit="submitted=true;">
                                    ...
                                    <input type="hidden" name="form_id" value="' . ( isset( $atts[ 'webform_id' ] ) ? esc_attr( $atts[ 'webform_id_alt' ] ) : '' ) . '" />
