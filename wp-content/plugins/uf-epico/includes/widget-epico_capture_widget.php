...
class Widget_epico_capture_widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				'description'	=>	__( 'Capture version for the Epico theme.', 'uf-epico' )
			)
		,array( 'width' => 495)
...
add_action( 'widgets_init', create_function( '', 'register_widget("Widget_epico_capture_widget");' ) );
