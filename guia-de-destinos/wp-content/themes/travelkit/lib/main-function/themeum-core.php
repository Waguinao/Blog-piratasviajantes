...
.btn.btn-primary,.woocommerce a.button:hover{ border-color: #e8141b; }';
        ...
        ********************************** */
        ...
        if ( get_theme_mod( 'header_color' ) ) {
            $output .= '.site-header{ background-color: rgba(255, 255, 255, 0.95); }';
        }
        ...
        if ( get_theme_mod( 'navbar_text_color' ) ) {
            $output .= '.header-solid .common-menu-wrap .nav>li.menu-item-has-children:after, .header-borderimage .common-menu-wrap .nav>li.menu-item-has-children:after, .header-solid .common-menu-wrap .nav>li>a, .header-borderimage .common-menu-wrap .nav>li>a{ color: #1d5ba7; }';
        }
