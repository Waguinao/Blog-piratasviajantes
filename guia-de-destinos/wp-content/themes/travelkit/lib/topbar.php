            ...
            if ( $topbaremail || $topbarphone ) {  ?>
                <div class="col-sm-9">
                    <div class="topbar-contact">
                        <span><strong><?php  esc_html_e( 'Call Us: ', 'travelkit' ); ?></strong><?php echo esc_attr($topbarphone);?></span>
                        <span><strong><?php  esc_html_e( 'Email: ', 'travelkit' ); ?></strong><?php print $topbaremail;?></span>
                    </div>
                </div>
            <?php } ?>    
            <?php  if ( $topbarsocial ) {  ?>
